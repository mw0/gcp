    ...
    **Iteration**
        ...
        if (_proxy):
            ...
            if dtype is None:
                if (isinstance(data, list)):
                    ...
                    try:
                        import graphlab.numpy_loader
                        if graphlab.numpy_loader.numpy_activation_successful():
                            ret = graphlab.numpy._fast_numpy_to_sarray(data)
                            # conversion is good!
                            # swap the proxy.
    ...
    def subslice(self, start=None, stop=None, step=None):
        ...
        step: int or None (default)
            The step position of the slice
    ...
    def argmax(self):
        ...
        sf = gl.SFrame(self).add_row_number()
        sf_out = sf.groupby(key_columns=[],operations={'maximum_x1':gl.aggregate.ARGMAX('X1','id')})
    ...
    def argmin(self):
        ...
        sf = gl.SFrame(self).add_row_number()
        sf_out = sf.groupby(key_columns=[],operations={'minimum_x1':gl.aggregate.ARGMIN('X1','id')})
