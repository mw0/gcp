...
from graphlab.util import _make_temp_directory, _make_temp_filename
import tempfile
...
class Ec2ExecutionEnvironment(ExecutionEnvironment):
    ...
    def _start_commander_host(env_name, config, s3_folder_path, num_hosts, additional_packages,
        ...
        tags['Name'] = env_name
        commander = _ec2_factory(config.instance_type, region = config.region,
    ...
    def run_job(job):
        ...
        cluster_controller = environment.cluster_controller
        ec2_config = environment.ec2_config
