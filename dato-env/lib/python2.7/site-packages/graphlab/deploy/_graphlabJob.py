...
## Hack: Force graphlab to be in the sys.path ##
## We know graphlab root dir is ../../ of the current script ##
_gl_dir = _os.path.abspath(_os.path.join(
        _os.path.dirname(_os.path.realpath(__file__)), '..', '..'))
if _gl_dir not in _sys.path:
        _sys.path.append(_gl_dir)
_logging.info('GraphLab HOME: ' + _gl_dir)
