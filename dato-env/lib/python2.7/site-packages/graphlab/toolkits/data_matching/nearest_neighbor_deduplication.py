...
def _engineer_distance_features(dataset, distance):
    ...
    'weighted_jaccard', 'cosine', and 'dot_product' distances, string features
    are transformed into counts of 3-character shingles.
    ...
    for i, (comp_ftrs, comp_dist, weight) in enumerate(distance):
        ...
        elif comp_dist in ['jaccard', 'weighted_jaccard', 'cosine', 'dot_product']:
...
def create(datasets, row_label=None, features=None, grouping_features=None,
    ...
    if row_label:
        ...
        row_label_type = datasets.values()[0][row_label].dtype()
    ...
    col_type_dict = {k: v for k, v in zip(sf_union.column_names(),
                                          sf_union.column_types())}
