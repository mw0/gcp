...
<https://dato.com/learn/gallery>`_, `How-tos
<https://dato.com/learn/how-to>`_, and the `recommender systems chapter of the
User Guide
<https://dato.com/learn/userguide/recommender/introduction.html>`_
